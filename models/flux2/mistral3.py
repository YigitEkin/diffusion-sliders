...
class Mistral3PreTrainedModel(PreTrainedModel):
    ...
    # Enable device_map support for distributed inference
    _supports_torch_device_map = True
    _no_split_modules = ["Mistral3RMSNorm", "Mistral3PatchMerger", "Mistral3MultiModalProjector"]
